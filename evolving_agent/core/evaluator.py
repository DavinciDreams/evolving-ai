...
class OutputEvaluator:
    ...
    async def _evaluate_criterion(
        ...
        try:
            ...
            prompt = self._create_evaluation_prompt(query, output, criterion, context_info)
            ...
            score, feedback = self._parse_evaluation_response(evaluation_response, criterion)
    ...
    def _create_evaluation_prompt(
        ...
        description = criterion_descriptions.get(criterion, f"Evaluate the {criterion} of the output")
    ...
    async def get_evaluation_insights(self) -> Dict[str, Any]:
        ...
        try:
            ...
            overall_scores = [eval_result.overall_score for _, _, eval_result in recent_evaluations]
            ...
            return {
                ...
                "common_weaknesses": [weakness for weakness, count in common_weaknesses],
                "recommended_improvements": [suggestion for suggestion, count in common_suggestions],
                "confidence_level": sum(eval_result.confidence for _, _, eval_result in recent_evaluations) / len(recent_evaluations)
            }
    ...
    async def create_evaluation_memory(self, evaluation: EvaluationResult, query: str, output: str) -> MemoryEntry:
