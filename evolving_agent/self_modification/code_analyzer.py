...
class CodeAnalyzer:
    ...
    async def analyze_performance_patterns(
        ...
        try:
            ...
            logger.info(
                f"Code analysis completed. Improvement potential: {improvement_potential:.2f}"
            )
        ...
        try:
            ...
            if str(file_path) in self.code_cache:
                analysis["lines_of_code"] = len(
                    self.code_cache[str(file_path)].splitlines()
                )
    ...
    def _analyze_evaluation_patterns(
    ...
    async def _identify_improvement_opportunities(
        ...
        try:
                ...
                opportunities.append(
                    {
                        ...
                        "priority": 0.8,
                        "affected_functions": complexity_metrics.get(
                            "high_complexity_functions", []
                        ),
                ...
                opportunities.append(
                    {
                        ...
                        "priority": 0.9,
                        "improvement_areas": evaluation_analysis.get(
                            "improvement_areas", []
                        ),
            ...
            if (
                total_error_handling / total_functions < 0.3
            ):  # Less than 30% functions have error handling
                opportunities.append(
                    {
                        "type": "error_handling",
    ...
    def _calculate_improvement_potential(
        self, opportunities: List[Dict[str, Any]], evaluation_insights: Dict[str, Any]
    ) -> float:
        ...
        try:
            ...
            weighted_score = sum(opp.get("priority", 0) for opp in opportunities) / len(
                opportunities
            )
            ...
            for opp_type, opps in by_type.items():
                if opp_type == "complexity_reduction":
                    ...
                    recommendations.extend(
                        [opp.get("suggested_action", "") for opp in opps]
                    )
    ...
    async def analyze_file(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if '"""' not in content and "'''" not in content:
                suggestions.append(
                    "Add comprehensive docstrings to improve code documentation"
                )
            ...
            if "async def" in content and "await" not in content:
                suggestions.append(
                    "Review async function implementations for proper await usage"
                )
                ...
                if Path(file_path).exists():
                    ...
                    if analysis.get("metrics", {}).get("complexity", 0) > 15:
                        complex_functions.append(
                            {
                                "file": file_path,
                                "complexity": analysis.get("metrics", {}).get(
                                    "complexity", 0
                                ),
                            }
                        )
